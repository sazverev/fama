...
"><i title="'.$arProp['NAME'].': '.$arOneValue['NAME'].'"></i>'.$str.'</li>';
							...
							{
								$templateRow .= '<a href="#" class="close1"><li class="item '.$arOneValue['CLASS'].'" '.$arOneValue['STYLE'].' data-treevalue="'.$arProp['ID'].'_'.$arOneValue['ID'].'" data-showtype="li" data-onevalue="'.$arOneValue['ID'].'" title="'.$arProp['NAME'].': '.$arOneValue['NAME'].'"><i></i><span class="cnt" style="width: 157px;">'.$arOneValue['NAME'].'</span></li></a>';
							}
						}
					}
					$templateRow .= '</ul></div>'.

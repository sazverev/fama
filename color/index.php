...
$APPLICATION->SetPageProperty("title", "Колористика ");
$APPLICATION->SetPageProperty("description", "В данном разделе представлены полные цветовые палитры продуктов FaMa и BIOFA, палитры RAL и NCS. Готовые цветовые проекты. Коллекция авторских цетов, разработанных нашей Колористической студей и дизайнером Еленой Зориной.");
$APPLICATION->SetPageProperty("keywords", "визуальный подбор цвета фасада дома, палитра цветов, RAL");
...
$APPLICATION->SetTitle("Цветовые палитры");

...
Loader::includeModule("iblock");
	...
	//if($USER->IsAdmin())
	{
		...
		$sql = "SELECT NAME, TITLE, REAL_URL, NEW_URL, SORT FROM b_sotbit_seometa_chpu WHERE ACTIVE = 'Y' AND REAL_URL LIKE '%".$url."filter/%' ORDER BY NAME";
	...
	if(!empty($up_tags))
	{
		$url = urldecode($APPLICATION->GetCurDir());
		?>
		<div class="section_block">
			<div class="sections_wrapper">
				<div class="list items">
						<?
						foreach($up_tags as $sotbit)
						{
							$c=""; 
							if(urldecode($sotbit['REAL_URL']) == $url)
								$c = "active";
							?>
								<div class="item_top_tag <?=$c?>">
									<div class="name">

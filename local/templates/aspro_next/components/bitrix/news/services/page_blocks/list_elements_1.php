				...
				<tbody>
					<tr>
						...
						<td class="col-md-3 col-sm-4 col-xs-5 valign">
							<div class="btns">
								<span><span class="btn btn-default btn-lg white transparent animate-load" data-event="jqm" data-param-form_id="SIMPLE_FORM_2_VIlBr" data-name="question"><span><?=(strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : GetMessage('S_ASK_QUESTION'))?></span></span></span>
							</div>
						</td>
					</tr>
				</tbody>
...
<?if($arSeoItems):?>
	...
	if($arSeoItem)
	{
		...
		$arLandingFilter = array(
			array(
				"LOGIC" => "OR",
				array("PROPERTY_SECTION_SERVICES" => false),
				array("PROPERTY_SECTION_SERVICES" => $arSeoItem["PROPERTY_SECTION_SERVICES_VALUE"] ? $arSeoItem["PROPERTY_SECTION_SERVICES_VALUE"] : $arSection["ID"]),
			),
	...
	else
	{
		$arLandingFilter = array(
			array(
				"LOGIC" => "OR",
				array("PROPERTY_SECTION_SERVICES" => false),
				array("PROPERTY_SECTION_SERVICES" => $arSection["ID"]),
			),
			"!ID" => $arTmpRegionsLanding,
		);
	}

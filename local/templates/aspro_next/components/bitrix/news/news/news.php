...
<?else:?>
	...
	"ACTIVE_COMPONENT" => "N"
			...
			<div class="outer">
<!--
				<span><span class="btn btn-default btn-lg white animate-load" data-event="jqm" data-param-form_id="ASK" data-name="question">
						<span><?=(strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : GetMessage('S_ASK_QUESTION'))?></span>
					</span>
				</span>
-->
				<script data-b24-form="click/74/evlw72" data-skip-moving="true">
				(function(w,d,u){
				var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);
				var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);
				})(window,document,'https://cdn-ru.bitrix24.ru/b11298180/crm/form/loader_74.js');
				</script>
				<button class="btn twosmallfont colored white" >Задать вопрос</button>
			</div>
		</div>

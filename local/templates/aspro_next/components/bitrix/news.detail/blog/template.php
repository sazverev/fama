...
<div itemid="https://<?=$_SERVER['HTTP_HOST']?>/<?=$arResult["DETAIL_PAGE_URL"]?>" itemscope itemtype="http://schema.org/Article">
...
?>
    ...
    <meta itemprop="datePublished" content="<?=date("Y-m-d",strtotime($arResult["DATE_CREATE"]))?>">
    <meta itemprop="dateModified" content="<?=date("Y-m-d",strtotime($arResult["TIMESTAMP_X"]))?>">
	<meta itemprop="image" content="https://<?=$_SERVER['HTTP_HOST']?>/<?=$img?>">
    <meta itemprop="articleSection" content="<?=$arResult['SECTION']['PATH'][0]['NAME']?>">

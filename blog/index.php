...
$APPLICATION->SetPageProperty("description", "Статьи о работе с лакокрасочными материалами и конкретными продуктаи от FaMa и BIOFA, о подготовке поверхностей, работе с оборудованием и многом другом.");
$APPLICATION->SetPageProperty("title", "Статьи, как работать с красками и маслами");

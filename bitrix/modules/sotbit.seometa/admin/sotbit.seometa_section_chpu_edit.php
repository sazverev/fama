...
$tabControl->AddViewField( 'ID', GetMessage( "SEO_META_EDIT_ID" ), $ID);
$tabControl->AddCheckBoxField( "ACTIVE", GetMessage( "SEO_META_EDIT_ACT" ), false, "Y",
    $Section['ACTIVE'] == "Y" || !isset($Section['ACTIVE'])
);
$tabControl->AddEditField( "SORT", GetMessage( "SEO_META_EDIT_SORT" ), true,
    [
        "size" => 6,
        "maxlength" => 255
    ],
...
$tabControl->AddEditField( "NAME", GetMessage( "SEO_META_EDIT_NAME" ), true,
    [
        "size" => 50,
        "maxlength" => 255
    ],
...
$tabControl->BeginCustomField( "PARENT_CATEGORY_ID", GetMessage( 'SEO_META_EDIT_PARENT_CATEGORY_ID' ));

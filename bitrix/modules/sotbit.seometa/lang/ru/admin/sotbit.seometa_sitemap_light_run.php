<?
$MESS["SEO_META_ERROR_SITEMAP_NOT_FOUND"] = "Настройка не найдена";
$MESS["SEO_META_ERROR_SITE_SITEMAP_NOT_FOUND"] = "Основная карта сайта не найдена";
$MESS["SEO_META_ERROR_CHPU_NOT_FOUND"] = "Не найдены активные ЧПУ";
...
$MESS["SEO_META_ERROR_SITEMAP_FILTER_TYPE_NOT_FOUND"] = 'Не найден вид фильтра';
$MESS["SEO_META_SITEMAP_RUN_INIT"] = "Выполнено";

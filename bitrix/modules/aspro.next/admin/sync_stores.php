...
if($RIGHT >= "R"){
	...
	<?else:?>
		<?if(htmlspecialcharsbx($_REQUEST["success"])):?>
			<?echo CAdminMessage::ShowMessage(array("MESSAGE" => GetMessage("NEXT_MODULE_SYNC_OK"), "TYPE" => "OK"));?>
		<?endif;?>
		<?if(htmlspecialcharsbx($_REQUEST["save"])):?>
			<?echo CAdminMessage::ShowMessage(array("MESSAGE" => GetMessage("NEXT_MODULE_SAVE_OK"), "TYPE" => "OK"));?>
		<?endif;?>
		<?$tabControl->Begin();?>

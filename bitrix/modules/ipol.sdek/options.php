			...
			switch($Option[0]){
                ...
                case 'sender_street' :
                    Tools::placeOptionRow(
                        Tools::getMessage('OPT_sender_address'),
                            '<input type="text" name="sender_street" size="30" placeholder="'.Tools::getMessage('OPT_sender_street').'" value="'.\Ipolh\SDEK\option::get('sender_street').'">&nbsp;
                            <input type="text" name="sender_house" size="5" placeholder="'.Tools::getMessage('OPT_sender_house').'" value="'.\Ipolh\SDEK\option::get('sender_house').'">&nbsp;
                            <input type="text" name="sender_flat"  size="5" placeholder="'.Tools::getMessage('OPT_sender_flat').'"  value="'.\Ipolh\SDEK\option::get('sender_flat').'">'
                    );
                break;
                case 'sender_house' : break;case 'sender_flat' : break;

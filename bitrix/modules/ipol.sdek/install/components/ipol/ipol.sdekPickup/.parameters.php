...
$arComponentParameters = array(
	"PARAMETERS" => array(
		"MODE" => array(
			...
			"TYPE"     => "LIST",
			"VALUES"   => array('both' => GetMessage('IPOLSDEK_FRNT_BOTHPROFS'), 'PVZ' => GetMessage('IPOLSDEK_PROF_PICKUP'), 'POSTAMAT' => GetMessage('IPOLSDEK_PROF_POSTAMAT')),
			"DEFAULT" => 'both'
		),
		"NOMAPS" => array(
			"PARENT"   => "BASE",
		...
		"SEARCH_ADDRESS" => array(
            "PARENT"   => "BASE",
            "NAME"     => GetMessage('IPOLSDEK_COMPOPT_SEARCH_ADDRESS'),
            "TYPE"     => "CHECKBOX",
            "DEFAULT"  => "N"
        ),
		"FORBIDDEN" => array(
			...
			"TYPE"     => "LIST",
			"VALUES"   => array(0 => '', 'pickup' => GetMessage('IPOLSDEK_PROF_PICKUP'), 'courier' => GetMessage('IPOLSDEK_PROF_COURIER'), 'inpost' => GetMessage('IPOLSDEK_PROF_POSTAMAT')),
			"SIZE"     => 3,
			"MULTIPLE" => "Y",
		),
		"PAYER" => array(

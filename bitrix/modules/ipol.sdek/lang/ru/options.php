...
<li>Зарегистрироваться под своим адресом электронной почты в системе технической поддержки СДЭК на <a href='https://jira.cdek.ru/servicedesk/customer/user/login?destination=portals' target='_blank'>сайте</a> и авторизоваться в ней. Затем в списке разделов выбрать \"Проблемы по ЛК и Интеграции\" и запросить доступ к интеграции через него. В ответ придет информация об Account и Secure_password для доступа к API. Эти данные надо вбить в соответствующие поля.<br>
